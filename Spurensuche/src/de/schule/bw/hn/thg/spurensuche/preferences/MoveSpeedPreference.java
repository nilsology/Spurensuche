 ...
 */
package de.schule.bw.hn.thg.spurensuche.preferences;

import org.mapsforge.applications.android.advancedmapviewer.R;

import de.schule.bw.hn.thg.spurensuche.Spurensuche;
...
public class MoveSpeedPreference extends SeekBarPreference {
	...
	public MoveSpeedPreference(Context context, AttributeSet attrs) {
		...
		this.seekBarCurrentValue = this.preferencesDefault.getInt(this.getKey(), Spurensuche.MOVE_SPEED_DEFAULT);
		this.max = Spurensuche.MOVE_SPEED_MAX;
	}
