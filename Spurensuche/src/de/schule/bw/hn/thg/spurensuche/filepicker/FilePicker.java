 ...
 */
package de.schule.bw.hn.thg.spurensuche.filepicker;
...
import de.schule.bw.hn.thg.spurensuche.filefilter.ValidFileFilter;
...
public class FilePicker extends Activity implements AdapterView.OnItemClickListener {
	...
	/*BIR */
	// private static final String DEFAULT_DIRECTORY = "/storage/sdcard0/Download"; // für Tablet 
	// private static final String DEFAULT_DIRECTORY = "/mnt/sdcard/Download"; // für BlueStacks
	private static final String DEFAULT_DIRECTORY = "/"; // Standard
